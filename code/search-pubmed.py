...
parser = argparse.ArgumentParser("pubmed")
...
parser.add_argument('--learning_rate', type=float, default=0.1, help='init pubmed learning rate')
...
h, bench = main(args.cycles, args.population_size, args.sample.size)
f = open("drive/MyDrive/GNN-NAS-Group10/pubmed_bench.txt", "w")
